	...
	<body>
		...
		<legend align="center">Club Member Registration</legend>
			<table>
				...
				<td>:</td>
				<td><input type="radio" name="u_gender" value="Male"><span>Male</span>
				<input type="radio" name="u_gender" value="Female"><span>Female</span> </td><td><span> <?php echo $err_gender;?></span></td><br>
				</tr>
				<tr>
				...
				<td>:</td>
					...
					<input type="checkbox"value="news" name ="u_source[]">News Article</td><td> <span><?php echo $err_source;?></span></td></br>
				</tr>			
				<tr>
				<td><span>Bio</span></td>
				<td>:</td>
